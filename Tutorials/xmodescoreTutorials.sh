...
$QBHOME/bin/qbbuster --pdbFile 8alx+H.pdb --sfFile 8alx+H.mtz --XmodeScore 8alx-tautomers_depot  --makecif divcon --qmWeight 7.0 --protonation skip --region-radius 0.0 --buffer-radius 0.0 --mmMethod amberff14sb --qmMethod pm6 --ncycles 2 --nSmallCycles 50 --dir Xmode_buster --selection "/B/*/1..15//" --engine buster --protonateTautomers skip --Nproc 8 --v 1
