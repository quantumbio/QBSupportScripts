...
$QBHOME/bin/qbdivcon --pdbFile 1bzc+H.pdb --sfFile 1bzc.mtz --XmodeScore --protonation Skip --protomers "0" --exploreFlip --exploreChiral --exploreDocking --engine divcon --protonateTautomers divcon --qmMethod pm6 --mmMethod amberff14sb --nSmallCycles 40 --region-radius 3.0 --selection "resname TPI and resid 902 and chain A" --dir testXmode --Nproc 16
